...
\begin{enumerate}
	...
	\item Sistem tidak mengimplementasikan estimasi kebutuhan energi berdasarkan jarak tempuh menuju \textit{home position}, prediksi sisa waktu terbang, maupun estimasi konsumsi daya motor, serta tidak menerapkan \textit{energy-aware path planning}. Aktivasi fitur \textit{Return-to-Launch} (RTL) dilakukan menggunakan ambang batas baterai tetap (\textit{fixed threshold}) sebesar 15\% dengan nilai persentase baterai yang diperoleh langsung dari telemetri \textit{flight controller} PX4.
\end{enumerate}
