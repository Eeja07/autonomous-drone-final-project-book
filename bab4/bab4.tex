...
Setelah proses pelatihan selesai, performa model deteksi YOLOv8n hasil \textit{fine-tuning} dievaluasi menggunakan data pengujian yang tidak terlihat sebelumnya. Rincian nilai metrik evaluasi akhir dari model tersebut ditunjukkan pada Tabel \ref{tab:metric_result}.
