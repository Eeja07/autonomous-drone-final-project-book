...
Gambar \ref{fig:blokdiagram5} menunjukkan arsitektur mesin pengambil keputusan otonom yang bekerja berdasarkan evaluasi kondisi sistem dan kejadian dinamis. Logika pengambil keputusan ini membagi proses menjadi tiga tahap utama secara sekuensial: monitoring kondisi sistem untuk mengumpulkan data telemetri, evaluasi kejadian (*event*) untuk menentukan prioritas kondisi, dan pemilihan tindakan otonom yang sesuai. Struktur ini dirancang untuk mempertahankan keamanan penerbangan dengan memprioritaskan keselamatan drone apabila terdeteksi kondisi kritis di lapangan.
