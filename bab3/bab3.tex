...
\begin{lstlisting}[language=Python, caption={Perpindahan diagram keadaan (\textit{State Machine}) dengan tiga lapis sistem keselamatan}, label={lst:scoutstate}]
	...
	# 3. Eksekusi Diagram Keadaan Scout
