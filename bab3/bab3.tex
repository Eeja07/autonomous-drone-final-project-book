...
\begin{enumerate}
	...
	Komponen ini dirancang sebagai struktur dasar untuk menampung baterai utama drone, Raspberry Pi 5, dan casing power supply. Dudukan ini diletakkan tepat di bagian tengah bawah rangka S500 secara simetris untuk memastikan distribusi beban yang merata pada keempat motor penggerak.
	...
	\begin{figure}[H]
		...
		\begin{subfigure}[b]{0.45\textwidth}
			\centering
			\includegraphics[width=0.9\linewidth]{bab3/casing_baterai_3d_1}
			\caption{Desain 3D Casing baterai 1 (Desain Awal)}
			\label{fig:casing-baterai-awal-3d-1}
		\end{subfigure}
		\hfill
		\begin{subfigure}[b]{0.45\textwidth}
			\centering
			\includegraphics[width=0.9\linewidth]{bab3/casing_baterai_3d_2}
			\caption{Desain 3D Casing baterai 2 (Desain Awal)}
			\label{fig:casing-baterai-awal-3d-2}
		\end{subfigure}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.9\linewidth]{bab3/casing_baterai_2d}
		\caption{Desain 2D dan Dimensi Casing baterai (Desain Awal)}
	...
	\begin{figure}[H]
		...
		\begin{subfigure}[b]{0.45\textwidth}
			\centering
			\includegraphics[width=0.9\linewidth]{bab3/casing_raspberry_pi_3d_1}
			\caption{Desain 3D Casing Raspberry Pi 1 (Desain Awal)}
			\label{fig:casing-raspberry-pi-awal-3d-1}
		\end{subfigure}
		\hfill
		\begin{subfigure}[b]{0.45\textwidth}
			\centering
			\includegraphics[width=0.9\linewidth]{bab3/casing_raspberry_pi_3d_2}
			\caption{Desain 3D Casing Raspberry Pi 2 (Desain Awal)}
			\label{fig:casing-raspberry-pi-awal-3d-2}
		\end{subfigure}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.9\linewidth]{bab3/casing_raspberry_pi_2d}
		\caption{Desain 2D dan Dimensi Casing Raspberry Pi (Desain Awal)}
		\label{fig:casing-raspberry-pi-awal-2d}
	\end{figure}
	
	\item Casing power supply (Desain Awal)\\
	Struktur pelindung untuk modul regulator daya (UBEC 5A) guna mencegah kontak fisik langsung dan melindungi sirkuit dari debu maupun kelembapan saat operasional di lapangan.
	
	\begin{figure}[H]
		\centering
		\begin{subfigure}[b]{0.45\textwidth}
			\centering
			\includegraphics[width=0.9\linewidth]{bab3/casing_power_supply_3d_1}
			\caption{Desain 3D Casing power supply 1 (Desain Awal)}
			\label{fig:casing-power-supply-awal-3d-1}
		\end{subfigure}
		\hfill
		\begin{subfigure}[b]{0.45\textwidth}
			\centering
			\includegraphics[width=0.9\linewidth]{bab3/casing_power_supply_3d_2}
			\caption{Desain 3D Casing power supply 2 (Desain Awal)}
			\label{fig:casing-power-supply-awal-3d-2}
		\end{subfigure}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.9\linewidth]{bab3/casing_power_supply_2d}
		\caption{Desain 2D dan Dimensi Casing power supply (Desain Awal)}
		\label{fig:casing-power-supply-awal-2d}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\begin{subfigure}[b]{0.45\textwidth}
			\centering
			\includegraphics[width=0.9\linewidth]{bab3/casing_kamera_3d_1}
			\caption{Desain 3D Casing kamera 1 (Desain Awal)}
			\label{fig:casing-kamera-awal-3d-1}
		\end{subfigure}
		\hfill
		\begin{subfigure}[b]{0.45\textwidth}
			\centering
			\includegraphics[width=0.9\linewidth]{bab3/casing_kamera_3d_2}
			\caption{Desain 3D Casing kamera 2 (Desain Awal)}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.9\linewidth]{bab3/casing_kamera_2d}
		\caption{Desain 2D dan Dimensi Casing kamera (Desain Awal)}
		\label{fig:casing-kamera-awal-2d}
	\end{figure}
	
	\item Tutup kamera (Desain Awal)\\
	Komponen penjepit yang mengunci badan kamera pada Casing kamera melalui sambungan baut. Desain simetris pada bracket kamera ini memastikan sensor visual tetap berada pada garis tengah drone untuk memudahkan perhitungan geometri pada sistem visi komputer.
	
	\begin{figure}[H]
		\centering
		\begin{subfigure}[b]{0.45\textwidth}
			\centering
			\includegraphics[width=0.9\linewidth]{bab3/tutup_kamera_3d_1}
			\caption{Desain 3D Tutup kamera 1 (Desain Awal)}
			\label{fig:tutup-kamera-awal-3d-1}
		\end{subfigure}
		\hfill
		\begin{subfigure}[b]{0.45\textwidth}
			\centering
			\includegraphics[width=0.9\linewidth]{bab3/tutup_kamera_3d_2}
			\caption{Desain 3D Tutup kamera 2 (Desain Awal)}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.9\linewidth]{bab3/tutup_kamera_2d}
		\caption{Desain 2D dan Dimensi Tutup kamera (Desain Awal)}
...
Pada tahap awal pengembangan, beberapa \textit{flight trial}, integrasi \textit{hardware}, dan \textit{debugging} program dilakukan menggunakan desain mekanik generasi awal (Desain 1) sebagaimana yang telah diuraikan pada tujuh komponen di atas. Karakteristik khusus dari Desain 1 ini adalah sebagian besar komponen utamanya masih dirancang menyatu secara fisik, menggunakan casing power supply terpisah untuk mewadahi modul regulator daya, serta dicetak menggunakan parameter densitas infill sebesar 30\% dengan pola Grid, sehingga menghasilkan bobot wahana yang relatif besar.

Setelah proses integrasi sistem kelistrikan selesai dan pengujian membuktikan kestabilan suplai daya, struktur mekanik drone direvisi secara komprehensif menjadi desain modular yang lebih efisien (Desain 2). Perubahan utama pada Desain 2 ini meliputi:
\begin{itemize}
	\item Desain ulang komponen menjadi beberapa unit mekanik modular terpisah, yaitu Casing baterai, Tutup casing baterai, Casing modem, Tutup casing modem, Casing Raspberry Pi, Tutup casing Raspberry Pi, Tutup clamp depan, serta Tutup clamp belakang.
	\item Penghilangan casing power supply terpisah yang kemudian digantikan oleh Casing modem guna menghemat ruang dan mengurangi beban \textit{payload}.
...
Meskipun Desain 2 telah modular, dalam fase pengujian awal ditemukan bahwa Konektor dudukan ke frame drone yang dibuat sebagai komponen terpisah memiliki ukuran penampang yang terlalu kecil, sehingga mudah patah ketika menopang payload wahana saat terbang. Sebagai langkah refinement (penyempurnaan), Konektor dudukan ke frame drone tersebut kemudian diintegrasikan langsung menjadi satu dengan Casing baterai. Penyempurnaan akhir ini dilakukan tanpa mengubah layout komponen, arsitektur sistem, posisi kamera, posisi Raspberry Pi, posisi modem, konsep modular, infill 10\%, maupun pola cetak Gyroid. Seluruh pengujian sistem otonom pada Bab 4 dilakukan menggunakan hasil refinement dari desain mekanik final ini.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{bab3/casing_baterai}
	\caption{Casing baterai dengan Konektor dudukan ke frame drone terintegrasi (Desain Final)}
	\label{fig:casing_baterai_baru}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{bab3/casing_raspberry_pi}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{bab3/casing_modem}
...
\begin{figure}[H]
	...
	\caption{Tampak samping penyederhanaan manajemen kabel (Desain Final)}
	\label{fig:tampak_samping_usb_baru}
\end{figure}

Visualisasi CAD di atas merepresentasikan seluruh komponen hasil revisi desain mekanik modular, termasuk Casing baterai yang telah disatukan dengan Konektor dudukan ke frame drone sebagai hasil akhir dari tahap penyempurnaan.

\begin{figure}[H]
	\centering
	\begin{subfigure}[b]{0.3\textwidth}
		\centering
		\includegraphics[width=\linewidth]{bab3/tutup_clamp}
		\caption{Tutup clamp}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.3\textwidth}
		\centering
		\includegraphics[width=\linewidth]{bab3/tutup_clamp_depan_kiri}
		\caption{Tutup clamp depan kiri}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.3\textwidth}
		\centering
		\includegraphics[width=\linewidth]{bab3/tutup_clamp_depan_kanan}
		\caption{Tutup clamp depan kanan}
	\end{subfigure}
	...
	\begin{subfigure}[b]{0.3\textwidth}
		\centering
		\includegraphics[width=\linewidth]{bab3/tutup_clamp_belakang_kiri}
		\caption{Tutup clamp belakang kiri}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.3\textwidth}
		\centering
		\includegraphics[width=\linewidth]{bab3/tutup_clamp_belakang_kanan}
		\caption{Tutup clamp belakang kanan}
	\end{subfigure}
	\caption{Tutup clamp depan dan Tutup clamp belakang (Desain Final)}
